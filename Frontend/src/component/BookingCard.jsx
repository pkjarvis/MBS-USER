      ...
      <div className="card-container h-[90%] flex items-center border-1 border-[#E0DFDF] rounded-md overflow-hidden gap-1 my-2">
        ...
        {props.val && (
          <>
            ...
            <div className="absolute  w-[40%] h-[16vw] left-[26vw] top-[10vw] bg-white shadow-2xl z-50  flex items-center justify-evenly">
              <div className="w-[30%] h-[15vw] mt-[2vw] ">
                <Barcode
                  ...
                  height={50}
                  width={1}
                  className="transform rotate-270 ml-[-3vw] my-[3vw]"
                />
              </div>
              ...
              <div className="w-[30%] h-[14vw] flex flex-col ml-[-3vw] mt-4">
                ...
                <span className="flex items-center justify-between mt-2">
                  ...
                  <p className="text-[#848386] text-md">03/SEAT: G1,G2</p>
                </span>
                <span className="flex items-center justify-between">
                  <p className="text-[#848386] text-md">DATE:</p>
                  <p className="text-[#848386] text-md">03/07/2025</p>
                </span>
                <span className="flex items-center justify-between">
                  <p className="text-[#848386] text-md">PRICE</p>
                  <p className="text-[#848386] text-md">Rs.360</p>
                </span>
                <span className="flex flex-col items-start justify-center gap-2 mt-2">
                  <p className="text-xl text-[#FF5295]">Azaad</p>
                  <p className="text-[#848386] text-md">NO. 01234982</p>
                </span>
              </div>
              ...
              <div className="flex flex-col items-center justify-evenly">
                ...
                <p className="text-sm font-medium text-[#848386]">10/07/2025</p>
                <p className="text-sm font-medium text-[#848386]">11:45PM</p>
              </div>
            </div>
          </>
        )}
        {/* <div className="absolute w-[40%] h-[16vw] left-[26vw] top-[10vw] bg-white shadow-2xl z-10  flex items-center justify-evenly">
          <div className="w-[30%] h-[15vw] mt-[2vw] ">
            <Barcode
              value="12ljsdowiewljwe"
              format={"CODE128"}
          ...
          <div className="w-[30%] h-[14vw] flex flex-col ml-[-3vw] mt-4">
            <p className="bg-[#FF5295] p-2 text-white font-medium text-center">Cinema Ticket</p>
            <span className="flex items-center justify-between mt-2">
              <p className="text-[#848386] text-md">THEATRE:</p>
              <p className="text-[#848386] text-md">03/SEAT: G1,G2</p>
            </span>
        ...
        <div className="right flex items-center justify-between w-[92%] p-1">
          <div className="rights-left flex flex-col py-1 justify-evenly gap-1">
            ...
            <p className="text-sm font-semibold">Harry Potter Season 3</p>
