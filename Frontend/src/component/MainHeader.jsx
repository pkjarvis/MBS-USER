  ...
  return (
     ...
     <div className="theatre-container font-[Inter]">
            ...
            <span className="flex items-center justify-start mx-[3vw] gap-1 mt-2">
                ...
                <a href="http://localhost:3000/movie" className='cursor-pointer font-light text-zinc-500'>{props.headerlink} </a>
                <a href="http://localhost:3000/showtime" className='cursor-pointer'> {props.nextlink}</a>
            </span> 
