    ...
    <div className='w-[30%] mt-[2vw]'>
        <div className="card-container w-[100%] h-[32vw]">
            <div className='w-[100%%] h-[26vw] rounded-xl overflow-hidden'>
                <img src="../src/assets/Chaava.png" alt="Chaava"  className='scale-122 w-[100%] h-[109%] ease-in-out hover:scale-100 hover:w-[100%] hover:h-[100%] hover:ease-in-out duration-300' />
            </div>
